  ...
  const projects = [
    {
      ...
      description: 'A Python-based virtual assistant with voice interaction capabilities.',
      image: 'https://img.freepik.com/free-photo/smart-speaker-house-control-innovative-technology_53876-102350.jpg?t=st=1738580584~exp=1738584184~hmac=f2e2276624cb9ef982456c2169bdb9e37f5580e09df959e086a80fe6195a0d02&w=826',
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="lg:ml-64">
        <section id="home" className="min-h-screen flex flex-col md:flex-row items-center gap-8 bg-gradient-to-b from-blue-400 via-blue-300 to-blue-200 p-8">
          ...
          <div className="w-full md:w-2/3">
            <h1 className="text-4xl font-bold text-blue-900 mb-4">Yamini Settipalli</h1>
            <p className="text-xl text-blue-800 mb-6">Aspiring Python Developer</p>
            <p className="text-blue-900 mb-8">
              I'm a passionate Python developer with experience in AI, machine learning, and Web development.
              I specialize in Python, Flask, Node.js, and cloud technologies, and I love solving complex problems
        ...
        <div className="bg-white">
          <section id="about" className="py-16 px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-blue-50 rounded-lg p-6 shadow-lg">
                <h3 className="text-xl font-semibold mb-4 text-blue-900">Technical Skills</h3>
                <div className="flex flex-wrap gap-2">
                  {['Python', 'Java', 'C', 'HTML', 'CSS', 'JavaScript', 'React js', 'Node js', 'MySQL', 'MongoDB', 'Data Structures and Algorithms'].map((skill) => (
                    <span
                      key={skill}
              ...
              <div className="bg-blue-50 rounded-lg p-6 shadow-lg">
                <h3 className="text-xl font-semibold mb-4 text-blue-900">Core Subjects</h3>
                <div className="flex flex-wrap gap-2">
                  {['Computer Networks', 'Operating Systems', 'Data Base Management System', 'Machine Learning', 'Deep Learning', 'Artificial Intelligence'].map(
                    (subject) => (
                      <span
                        key={subject}
                        className="px-3 py-1 bg-blue-100 text-blue-900 rounded-full text-sm"
            ...
            <div className="bg-blue-50 rounded-lg p-6 shadow-lg">
                <h3 className="text-xl font-semibold mb-4 text-blue-900">Soft Skills</h3>
                <div className="flex flex-wrap gap-2">
                  {['Communication', 'Problem Solving', 'Adaptability', 'Time Management', 'Teamwork'].map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1 bg-blue-100 text-blue-900 rounded-full text-sm"
                    >
          ...
          <section id="experience" className="py-16 px-8 bg-gray-50">
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg">
              <h3 className="text-xl font-bold text-blue-900">Software Development Engineer in Test (SDET) Intern</h3>
              <p className="text-blue-700">Amazon</p>
              <p className="text-gray-600">Chennai, Tamil Nadu | July 2024 - August 2024</p>
              <ul className="list-disc list-inside mt-4 text-gray-700">
                <li>Automated processes like skip OOBE and floor plan generation using ADB commands</li>
          ...
          <section id="education" className="py-16 px-8 bg-gray-50">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 shadow-lg">
                <h3 className="text-xl font-bold text-blue-900">B.Tech CSE(AIML)</h3>
              ...
              <div className="bg-white rounded-lg p-6 shadow-lg">
                <h3 className="text-xl font-bold text-blue-900">Intermediate (MPC)</h3>
              ...
              <div className="bg-white rounded-lg p-6 shadow-lg">
                <h3 className="text-xl font-bold text-blue-900">Secondary Education</h3>
